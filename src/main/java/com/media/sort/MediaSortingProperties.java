...
public class MediaSortingProperties {
    ...
    public static class DirectoryStructure {
        ...
        // Getters and setters
        public String getEmptyFolderDirectoryName() {
            return emptyFolderDirectoryName;
        }

        public void setEmptyFolderDirectoryName(String emptyFolderDirectoryName) {
            this.emptyFolderDirectoryName = emptyFolderDirectoryName;
        }
        ...
        public String getVideosDirectoryName() {
            return videosDirectoryName;
        }

        public void setVideosDirectoryName(String videosDirectoryName) {
            this.videosDirectoryName = videosDirectoryName;
        }

        public String getOriginalSubDirectoryName() {
            return originalSubDirectoryName;
        }

        public void setOriginalSubDirectoryName(String originalSubDirectoryName) {
            this.originalSubDirectoryName = originalSubDirectoryName;
        }

        public String getDuplicateSubDirectoryName() {
            return duplicateSubDirectoryName;
        }

        public void setDuplicateSubDirectoryName(String duplicateSubDirectoryName) {
            this.duplicateSubDirectoryName = duplicateSubDirectoryName;
        }

        public String getOthersDirectoryName() {
            return othersDirectoryName;
        }

        public void setOthersDirectoryName(String othersDirectoryName) {
            this.othersDirectoryName = othersDirectoryName;
        }
    }
    ...
    public static class LogFilePaths {
        ...
        // Getters and setters
        public String getImageErrorLogPath() {
            return imageErrorLogPath;
        }

        public void setImageErrorLogPath(String imageErrorLogPath) {
            this.imageErrorLogPath = imageErrorLogPath;
        }

        public String getVideoErrorLogPath() {
            return videoErrorLogPath;
        }

        public void setVideoErrorLogPath(String videoErrorLogPath) {
            this.videoErrorLogPath = videoErrorLogPath;
        }

        public String getMediaErrorLogPath() {
            return mediaErrorLogPath;
        }

        public void setMediaErrorLogPath(String mediaErrorLogPath) {
            this.mediaErrorLogPath = mediaErrorLogPath;
        }

        public String getPhotoOrganizerErrorLogPath() {
            return photoOrganizerErrorLogPath;
        }

        public void setPhotoOrganizerErrorLogPath(String photoOrganizerErrorLogPath) {
            this.photoOrganizerErrorLogPath = photoOrganizerErrorLogPath;
        }

        public String getFileComparisonLogPath() {
            return fileComparisonLogPath;
        }

        public void setFileComparisonLogPath(String fileComparisonLogPath) {
            this.fileComparisonLogPath = fileComparisonLogPath;
        }

        public String getEmptyFolderCleanupLogPath() {
            return emptyFolderCleanupLogPath;
        }

        public void setEmptyFolderCleanupLogPath(String emptyFolderCleanupLogPath) {
            this.emptyFolderCleanupLogPath = emptyFolderCleanupLogPath;
        }

        public String getFolderComparisonProgressLogPath() {
            return folderComparisonProgressLogPath;
        }

        public void setFolderComparisonProgressLogPath(String folderComparisonProgressLogPath) {
            this.folderComparisonProgressLogPath = folderComparisonProgressLogPath;
        }

        public String getVideoMp4ErrorLogPath() {
            return videoMp4ErrorLogPath;
        }

        public void setVideoMp4ErrorLogPath(String videoMp4ErrorLogPath) {
            this.videoMp4ErrorLogPath = videoMp4ErrorLogPath;
        }

        public String getVideoTgpErrorLogPath() {
            return videoTgpErrorLogPath;
        }

        public void setVideoTgpErrorLogPath(String videoTgpErrorLogPath) {
            this.videoTgpErrorLogPath = videoTgpErrorLogPath;
        }

        public String getVideoQtErrorLogPath() {
            return videoQtErrorLogPath;
        }

        public void setVideoQtErrorLogPath(String videoQtErrorLogPath) {
            this.videoQtErrorLogPath = videoQtErrorLogPath;
        }

        public String getVideoOtherErrorLogPath() {
            return videoOtherErrorLogPath;
        }

        public void setVideoOtherErrorLogPath(String videoOtherErrorLogPath) {
            this.videoOtherErrorLogPath = videoOtherErrorLogPath;
        }
    }
    ...
    public static class FileExtensions {
        ...
        public void setSupportedImageExtensions(Set<String> supportedImageExtensions) {
        ...
        public void setSupportedVideoExtensions(Set<String> supportedVideoExtensions) {
    ...
    public boolean isPerceptualHashEnabled() {
        return perceptualHashEnabled;
    }

    public void setPerceptualHashEnabled(boolean perceptualHashEnabled) {
        this.perceptualHashEnabled = perceptualHashEnabled;
    }
